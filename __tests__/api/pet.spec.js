...
const petId = 990734576;        // id do pet / um dos resultados esperados
    ...
    it("POST Pet", () => {
        ...
        return request              // chamada para a requisição
            ...
            .then((resposta) => {
                ...
                assert.equal(resposta.body.name, "Toquinho");  // valida o nome do pet
    ...
    it("PUT Pet", () => {
        ...
        return request      // chamada para a requisição
            ...
            .then((resposta) => {
                ...
                assert.equal(resposta.body.name, "Toquinho");
